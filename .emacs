...
(custom-set-variables
 ...
 '(flycheck-perlcriticrc "C:/dev/avnprod/development/tools/conf/perlcritic.conf")
 ...
 '(package-selected-packages
   (quote
    (json-mode solarized-theme gitignore-mode ng2-mode epl typescript-mode magit flymake groovy-mode pkg-info seq let-alist)))
